...
export class CategoryController {
    ...
    @Post("/create/:userId")
    async create(@Body() category: CreateCategoryDto, @Param('userId') id: number, @Res() response): Promise<Category> {
    ...
    @Post('/create/task/:id')
    async createTask(@Body() task: CreateTaskDto, @Param('id') id: number, @Res() response): Promise<Task> {
    ...
    @Put(':categoryId') update(@Param('categoryId') categoryId: number, @Body() updateCategoryDto: UpdateCategoryDto) {

        return this.categoryService.update(categoryId, updateCategoryDto);
    }

    @Delete(':id') remove(@Param('id') id: number, @Res() res) {
